...
import { postDiscordNewEvent } from "../../../lib/discordPoster";
...
apiRoute.post(async (req: NextApiRequest, res: NextApiResponse) => {
	...
	//add ObjectIds to the slots, groups and factions
	...
	await (await MyMongo).db("prod").collection("reforger_events").insertOne({
		name: body["eventName"],
...
apiRoute.put(async (req: NextApiRequest, res: NextApiResponse) => {
	...
	await (await MyMongo).db("prod").collection("reforger_events").updateOne(
